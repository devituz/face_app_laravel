                        ...
                        <div class="col-auto">
                            ...
                            <ul class="nav nav-tabs header-tabs">
                                <li class="nav-item" data-toggle="chart" data-target="#earningsChart" data-trigger="click" data-action="toggle" data-dataset="0">
                                    <a href="dashboard-project-management.html#" class="nav-link text-center active" data-bs-toggle="tab">
                                        <h6 class="header-pretitle text-secondary">
                                            Earnings
                                        </h6>
                                        <h3 class="mb-0">
                                ...
                                <li class="nav-item" data-toggle="chart" data-target="#earningsChart" data-trigger="click" data-action="toggle" data-dataset="1">
                                    <a href="dashboard-project-management.html#" class="nav-link text-center" data-bs-toggle="tab">
                                        <h6 class="header-pretitle text-secondary">
                                            Sessions
                                        </h6>
                                        <h3 class="mb-0">
                ...
                <div class="col-12 col-xl-8">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <!-- Button -->
                            <a href="dashboard-project-management.html#!" class="btn btn-sm btn-white">
                                Export
                            </a>
                        ...
                        <div class="table-responsive mb-0" data-list='{"valueNames": ["project-project", "project-status", "project-progress", "project-date"]}'>
                            <table class="table table-sm table-nowrap card-table table-hover">
                                ...
                                <tr>
                                    <th>
                                        <a href="dashboard-project-management.html#" class="text-body-secondary list-sort" data-sort="project-project">
                                            Project
                                        </a>
                                    </th>
                                    <th>
                                        <a href="dashboard-project-management.html#" class="text-body-secondary list-sort" data-sort="project-status">
                                            Status
                                        </a>
                                    </th>
                                    <th>
                                        <a href="dashboard-project-management.html#" class="text-body-secondary list-sort" data-sort="project-progress">
                                            Progress
                                        </a>
                                    </th>
                                    <th>
                                        <a href="dashboard-project-management.html#" class="text-body-secondary list-sort" data-sort="project-date">
                                            Due date
                                        </a>
                                    </th>
                                    <th class="text-end">
                                ...
                                <tr>
                                    <td class="project-project">
                                        ...
                                        <!-- Heading -->
                                        <h4 class="fw-normal mb-1">Update the API</h4>

                                        <!-- Text  -->
                                        <small class="text-body-secondary">Oki Doki Collective</small>

                                    </td>
                                    <td class="project-status">

                                        <!-- Badge -->
                                        <span class="badge text-bg-warning-subtle">In progress</span>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <!-- Dropdown -->
                                        <div class="dropdown">
                                            <a href="dashboard-project-management.html#" class="dropdown-ellipses dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <tr>
                                    <td class="project-project">
                                        ...
                                        <!-- Heading -->
                                        <h4 class="fw-normal mb-1">Release v1.2-Beta</h4>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="avatar-group justify-content-end">
                                            <a href="dashboard-project-management.html#!" class="avatar avatar-xs" data-bs-toggle="tooltip" title="Dianna Smiley">
                                                <img src="assets/img/avatars/profiles/avatar-1.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="dashboard-project-management.html#!" class="avatar avatar-xs" data-bs-toggle="tooltip" title="Ab Hadley">
                                                <img src="assets/img/avatars/profiles/avatar-2.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="dashboard-project-management.html#!" class="avatar avatar-xs" data-bs-toggle="tooltip" title="Adolfo Hess">
                                                <img src="assets/img/avatars/profiles/avatar-3.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                        </div>
                                ...
                                <tr>
                                    <td class="project-project">
                                        ...
                                        <!-- Heading -->
                                        <h4 class="fw-normal mb-1">GDPR Compliance</h4>
                                    ...
                                    <td class="project-status">
                                        ...
                                        <!-- Badge -->
                                        <span class="badge text-bg-success-subtle">Completed</span>
                                ...
                                <tr>
                                    <td class="project-project">
                                        ...
                                        <!-- Heading -->
                                        <h4 class="fw-normal mb-1">v1.2 Documentation</h4>
                                    ...
                                    <td class="project-status">
                                        ...
                                        <!-- Badge -->
                                        <span class="badge text-bg-danger-subtle">Cancelled</span>
                                ...
                                <tr>
                                    <td class="project-project">
                                        ...
                                        <!-- Heading -->
                                        <h4 class="fw-normal mb-1">Plan design offsite</h4>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="avatar-group justify-content-end">
                                            ...
                                            <a href="dashboard-project-management.html#!" class="avatar avatar-xs" data-bs-toggle="tooltip" title="Daniela Dewitt">
                                                <img src="assets/img/avatars/profiles/avatar-4.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <time class="small text-danger" datetime="2019-06-09">
                                                        <i class="fe fe-clock me-1"></i> Jun 9
                                                    </time>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <!-- Time -->
                                                    <time class="small text-body-secondary" datetime="2019-06-09">
                                                        <i class="fe fe-clock me-1"></i> Jun 9
                                                    </time>
                                    ...
                                    <form class="kanban-add-form">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <!-- Input -->
                                                <textarea class="form-control form-control-flush form-control-auto" data-autosize rows="1" placeholder="Draft your card"></textarea>
                                            ...
                                            <div class="col-auto">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!-- Icon -->
                                                    <span class="text-body-secondary small me-2">
                              <i class="fe fe-clock"></i>
                            </span>

                                                    <!-- Input -->
                                                    <input type="text" class="form-control form-control-sm form-control-flush form-control-auto text-body-secondary" data-flatpickr data-options='{"dateFormat": "M j"}' placeholder="No due date">
                ...
                <div class="col-12 col-xl-4">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <!-- Button -->
                            <a class="small" href="dashboard-project-management.html#!">View all</a>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <!-- Link -->
                            <a href="dashboard-project-management.html#!" class="small">View all</a>
                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <!-- Avatar -->
                                            <a href="dashboard-project-management.html#!" class="avatar">
                                        ...
                                        <div class="col ms-n2">
                                            ...
                                            <h4 class="fw-normal mb-1">
                                                <a href="dashboard-project-management.html#!">Launchday Logo</a>
                                            </h4>
                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ms-n2">
                                            ...
                                            <!-- Title -->
                                            <h4 class="fw-normal mb-1">
                                                <a href="dashboard-project-management.html#!">Example Grid</a>
                                            </h4>
                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ms-n2">
                                            ...
                                            <!-- Title -->
                                            <h4 class="fw-normal mb-1">
                                                <a href="dashboard-project-management.html#!">Screenshot Collection</a>
                                            </h4>
                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ms-n2">
                                            ...
                                            <!-- Title -->
                                            <h4 class="fw-normal mb-1">
                                                <a href="dashboard-project-management.html#!">Launchday Cover</a>
                                            </h4>
                        ...
                        <div class="card-header">
                            ...
                            <ul class="nav nav-tabs nav-tabs-sm card-header-tabs">
                                <li class="nav-item" data-toggle="chart" data-target="#trafficChart" data-trigger="click" data-action="toggle" data-dataset="0">
                                    <a href="dashboard-project-management.html#" class="nav-link active" data-bs-toggle="tab">
                                        All
                                    </a>
                                </li>
                                <li class="nav-item" data-toggle="chart" data-target="#trafficChart" data-trigger="click" data-action="toggle" data-dataset="1">
                                    <a href="dashboard-project-management.html#" class="nav-link" data-bs-toggle="tab">
                                        Direct
                                    </a>
                                </li>
                            </ul>
