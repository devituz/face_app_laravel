                        ...
                        <div class="card-header">
                            ...
                            <ul class="nav nav-tabs nav-tabs-sm card-header-tabs">
                                <li class="nav-item" data-toggle="chart" data-target="#trafficChart" data-trigger="click" data-action="toggle" data-dataset="0">
                                    <a href="index.html#" class="nav-link active" data-bs-toggle="tab">
                                        All
                                    </a>
                                </li>
                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <!-- Dropdown -->
                                            <div class="dropdown">
                                                <a href="index.html#" class="dropdown-ellipses dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="card-header">
                            ...
                            <ul class="nav nav-tabs nav-tabs-sm card-header-tabs">
                                <li class="nav-item" data-toggle="chart" data-target="#salesChart" data-trigger="click" data-action="toggle" data-dataset="0">
                                    <a class="nav-link active" href="index.html#" data-bs-toggle="tab">
                                        All
                                    </a>
                                </li>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive mb-0" data-list="{&quot;valueNames&quot;: [&quot;goal-project&quot;, &quot;goal-status&quot;, &quot;goal-progress&quot;, &quot;goal-date&quot;]}">
                            <table class="table table-sm table-nowrap card-table">
                                ...
                                <tr>
                                    <th>
                                        <a href="index.html#" class="text-body-secondary list-sort" data-sort="goal-project">
                                            Goal
                                        </a>
                                    </th>
                                    <th>
                                        <a href="index.html#" class="text-body-secondary list-sort" data-sort="goal-status">
                                            Status
                                        </a>
                                    </th>
                                    <th>
                                        <a href="index.html#" class="text-body-secondary list-sort" data-sort="goal-progress">
                                            Progress
                                        </a>
                                    </th>
                                    <th>
                                        <a href="index.html#" class="text-body-secondary list-sort" data-sort="goal-date">
                                            Due date
                                        </a>
                                    </th>
                                    <th class="text-end">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="avatar-group justify-content-end">
                                            <a href="index.html#!" class="avatar avatar-xs" data-bs-toggle="tooltip" title="Dianna Smiley">
                                                <img src="assets/img/avatars/profiles/avatar-1.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="index.html#!" class="avatar avatar-xs" data-bs-toggle="tooltip" title="Ab Hadley">
                                                <img src="assets/img/avatars/profiles/avatar-2.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="index.html#!" class="avatar avatar-xs" data-bs-toggle="tooltip" title="Adolfo Hess">
                                                <img src="assets/img/avatars/profiles/avatar-3.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="avatar-group justify-content-end">
                                            ...
                                            <a href="index.html#!" class="avatar avatar-xs" data-bs-toggle="tooltip" title="Daniela Dewitt">
                                                <img src="assets/img/avatars/profiles/avatar-4.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </td>
                ...
                <div class="col-12 col-xl-5">
                    ...
                    <div class="card card-fill">
                        <div class="card-header">
                            ...
                            <!-- Button -->
                            <a class="small" href="index.html#!">View all</a>
